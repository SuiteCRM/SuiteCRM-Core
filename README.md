...
Find out more about SuiteCRM 8 and check out the online demo [here](https://suitecrm.com/suitecrm8/)
...
See the [Release Notes](https://docs.suitecrm.com/8.x/admin/releases/) for more details and known issues in the beta build
