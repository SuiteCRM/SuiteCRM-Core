...
namespace App\Module\Processes\Service\RecordActions;
...
class DismissProcessAction implements ProcessHandlerInterface
{
    ...
    public function run(Process $process): void
    {
        ...
        // Purge all remaining async task items for this process
        $this->itemRepository->purgeByTaskId($id);

        // Soft-delete the process record
