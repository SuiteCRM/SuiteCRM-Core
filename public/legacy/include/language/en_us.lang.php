...
$app_strings = array(
    ...
    'LBL_CAMPAIGN_SEND_ERROR_THRESHOLD_EXCEEDED' => 'Send error threshold (%d) exceeded: %s',
    'LBL_CAMPAIGN_SEND_FAILURE_THRESHOLD_EXCEEDED' => 'Send failure threshold of %d exceeded',
